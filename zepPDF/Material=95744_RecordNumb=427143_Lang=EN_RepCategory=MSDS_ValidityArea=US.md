...
ZEP F-10 POWDERED HAND CLNR_140LB 
Version 2.1 
...
H371 May cause damage to organs (Lungs). 
SAFETY DATA SHEET 
...
:  No data available  
pH 
: 9.5 - 10.5, 1 %(as aqueous solution)  
...
:  Acute toxicity estimate : 4.09 mg/l 
Exposure time: 4 h 
...
: Danger: 
Hazard statements 
: Harmful if inhaled. May cause cancer. May damage fertility or the unborn child. May 
cause damage to organs (Lungs). May cause damage to organs (Lungs) through 
...
Call a POISON CENTER/doctor. IF exposed or concerned: Get medical advice/ 
attention.  
