...
ZEP PROFESSIONAL RECIRCULATING SPRAY WASH 
DETERGENT_40LB 
Version 1.1 
...
68439-46-3 
>= 1 - < 5 
Poly(oxy-1,2-ethanediyl), .alpha.-(phenylmethyl)-
.omega.-[(1,1,3,3-tetramethylbutyl)phenoxy]- 
60864-33-7 
>= 1 - < 5 
...
task being performed (e.g., sleevelets, apron, 
gauntlets, disposable suits) to avoid exposed skin 
surfaces. 
...
Product: 
Acute oral toxicity 
:  Acute toxicity estimate : 3,687 mg/kg   
...
Precautionary statements 
:  
Prevention: Do not breathe dust or mist. Wash skin thoroughly after handling. Do not 
eat, drink or smoke when using this product. Use only outdoors or in a well-ventilated 
...
rinsing. Immediately call a POISON CENTER/doctor. Wash contaminated clothing 
before reuse.  
