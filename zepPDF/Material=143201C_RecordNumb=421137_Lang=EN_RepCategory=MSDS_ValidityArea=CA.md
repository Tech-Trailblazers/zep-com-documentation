...
Components: 
butan-2-one O,O',O''-(methylsilylidyne)trioxime: 
Target Organs: Cardio-vascular system, Blood 
...
reaction. May cause damage to organs through prolonged or repeated exposure.  
Precautionary statements 
: Read label before use. If medical advice is needed, have product container or label at 
hand. Keep out of reach of children.  
Prevention: Contaminated work clothing should not be allowed out of the workplace. 
Wear protective gloves. Do not breathe dust.  
Response: Get medical advice/ attention if you feel unwell. IF ON SKIN: Wash with 
...
Storage: Store in a well-ventilated place. Protect from sunlight.  
